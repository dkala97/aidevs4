...
from generic_agent.tool_fetch_html_body import ToolFetchHtmlBody, create_tool_schema_fetch_html_body
...
class TaskNativeTools(NativeToolsIf):
    def __init__(self, shared_config: AgentConfig):
        self._tools = {
            ...
            "sleep": ToolSleep(),
            "fetch_html_body": ToolFetchHtmlBody(os.getenv("OKO_URL", ""), shared_config)
        }
        ...
        return [
            ...
            parameters={
                ...
                "properties": {
                    "answer": {
                        "type": "object",
                        "description": "Answer to be included into POST's request answer object.",
                        "properties": {
                            "action": {
                                "type": "string",
            ...
            create_tool_schema_fetch_html_body(tool_name="fetch_html_body")
        ]
