...
MODEL = resolve_model_for_provider(os.getenv("TASK_MODEL", "anthropic/claude-sonnet-4-6"))
...
INSTRUCTIONS = """
You are an autonomous agent solving a task using native tools.
- Use fetch_data to retrieve task data
- Use test_prompt to validate your solutions
- Use reset to start fresh when needed
Always follow the feedback from test_prompt.
Test flow is: reset, fetch_data, test_prompt
""".strip()
