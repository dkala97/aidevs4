...
_SPEC = importlib.util.spec_from_file_location("main_agent_root_config", _ROOT_CONFIG_PATH)
...
MODEL = _MODULE.MODEL
DEFAULT_SERVER_NAME = _MODULE.DEFAULT_SERVER_NAME
HUB_URL = _MODULE.HUB_URL
HUB_API_KEY = _MODULE.HUB_API_KEY
