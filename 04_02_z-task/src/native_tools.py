    ...
    def list_tools(self) -> list[dict[str, Any]]:
        return [
            create_tool_schema_auto_api(tool_name="verify", description=(
                "Tool used for executing actions."
            ...
            parameters={
                ...
                "properties": {
                    "answer": {
                        "type": "object",
                        "description": "Answer object containing action to be executed.",
                        "properties": {
                            "action": {
                                "type": "string",
                                "description": "Action to be executed. Discover available actions with `help` action."
                            }
                        },
                        "required": ["action"]
                    }
